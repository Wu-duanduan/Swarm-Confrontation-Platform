...
import os
import sys
from Network.IQL_network import MultiAgentDQN
...
def get_args():
    ...
    parser.add_argument("--model-prefix", type=str, default="best_dqn_model_agent_", help="模型文件名前缀")
...
def test_model(args, obsCenter):
    ...
    # 保存结果到文本文件
    file_path = os.path.join("test_results", "best_dqn_model.txt")
